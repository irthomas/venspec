...
def convolve_ils(lambda_um, delta_lambda_um, ils_gaussian_width, venus_um_grid, venus_radiance):
...
def detector_ils(lambda_ums, delta_lambda_um, ils_gaussian_width, venus_um_grid, venus_radiance):
