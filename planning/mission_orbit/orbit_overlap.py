    ...
    with PdfPages("%s.pdf" % key) as pdf:
        ...
        for days in range(45, 56+45, 1):
            ...
            for i, dt_start in enumerate(dt_starts):
                ...
                # incidence angles
                surf_ilumin = [sp.ilumin(SPICE_SHAPE_MODEL_METHOD, "VENUS", et, "IAU_VENUS", SPICE_ABCORR, orbit_d[key]
                                         ["spice_observer"], subpnt_xyz) for et, subpnt_xyz in zip(ets, subpnts_xyz)]
